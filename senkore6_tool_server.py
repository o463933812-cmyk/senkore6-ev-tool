...
APP_VERSION = '2026-07-21-senkore6-v35-final-tool-audit6'
_cached = None
...
def page_login(msg=""):
    ...
    notice = "<p style='font-size:13px;line-height:1.7;color:#444;margin:10px 0 14px'>このツールはnote購入者向けの限定公開です。URL・パスワードの第三者への共有、ツール内容の無断転載・二次配布を禁止します。</p>"
